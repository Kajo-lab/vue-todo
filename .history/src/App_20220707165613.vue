...
<main class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
	<div class="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10 gap-y-10">
		<section>
		<h1 class="text-4xl text-yellow-500 mb-6">CREATE A TODO</h1>
				<h4 class="mb-2">Add a todo</h4>
		...
		<section>
				<h3>TODO LIST</h3>
				<div id="todo-list">
					<div class="flex gap-6" v-for="todo in todos_asc" :key="`todo-item ${todo.done && 'done'}`">
