...
<main>
	<div class="relative bg-white px-6 pt-10 pb-8">
		...
		<section>
				...
				<div id="todo-list">
					<div class="flex mb-4" v-for="todo in todos_asc" :class="`todo-item ${todo.done && 'done'}`">

						<div class="todo-content flex gap-x-4 items-center py-2">

						<label>
							<input type="checkbox" v-model="todo.done" class="w-full bg-gray-200 hover:bg-gray-300 cursor-pointer 
									w-6 h-6 border-3 border-amber-500 checked:bg-green-500 focus:outline-none rounded-lg"/>
						</label>
