...
<main class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-neutral-800 py-6 sm:py-12">
		...
		<section>
				...
				<div id="todo-list ">
					<div class="flex mb-4" v-for="todo in todos_asc" :class="`todo-item ${todo.done && 'done'}`">
						...
						<div class="flex gap-6 todo-content">
						<label>
							...
							<button class="h-10 w-20 text-white rounded-lg bg-red-500 hover:bg-red-600" >Delete</button>
