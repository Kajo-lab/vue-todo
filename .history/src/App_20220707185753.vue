				...
				<div id="todo-list">
					...
					<div v-for="todo in todos_asc" :class="`todo-item ${todo.done && 'done'}`">
						<div class="flex-none sm:flex todo-content items-center py-2">
							<div class="flex w-full sm:ml-4 shadow appearance-none border-none rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
								<label>
