...
<main class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gradient-to-r from-yellow-500 via-green-500 to-yellow-500 py-6 sm:py-12">
