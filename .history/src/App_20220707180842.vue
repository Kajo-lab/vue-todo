		...
		<section>
				...
				<div id="todo-list">
					<div class="flex mb-4" v-for="todo in todos_asc" :class="`todo-item ${todo.done && 'done'}`">
						...
						<div class="todo-content flex gap-6 items-center border-b border-teal-500 py-2">
						<label class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded">
