	...
	<div class="relative bg-white px-6 pt-10 pb-8">
		...
		<h1 class="text-4xl text-yellow-500 mb-6">CREATE A TODO</h1>
				...
				<form id="new-todo-form" class="flex gap-6" @submit.prevent="addTodo">
					...
					<button type="submit" value="Add todo" class="h-10 w-32 text-white rounded-lg bg-green-500 hover:bg-green-600">Add todo</button>
				</form>
		</section>
				...
				<div id="todo-list">
					...
					<div v-for="todo in todos_asc" :class="`todo-item ${todo.done && 'done'}`">
						<div class="flex-none sm:flex todo-content items-center py-2">
							...
							<button class="h-10 w-20 text-white rounded-lg bg-red-500 hover:bg-red-600 mt-4 sm:ml-4" @click="removeTodo(todo)">Delete</button>
						</div>
					</div>
